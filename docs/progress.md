...
- Run one-pass Text Journey rehearsals for every newly added Cultural Format Structure entry, review the findings, and update entries or chooser guidance where selection boundaries prove unclear.
