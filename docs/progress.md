...
- Decide whether the remaining text-first structure fields should move into sound, video, and mixed-media Medium Plans after Text Journey and Image Medium Plan rehearsals harden Medium Output Shape Recommendation behavior. Image now has optional Medium Output Shape Recommendation rationale, but not adapted Cultural Format Structure.
